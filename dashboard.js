...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 💥 CORREÇÃO DO CUBO SUMINDO: Um timeout garante que a div está na tela antes do Swiper ser chamado
    setTimeout(() => {
        const swiperContainer = document.querySelector(".superAppSwiper");
        if (swiperContainer) {
    ...
    }, 100); // 100ms de fôlego pro DOM carregar
